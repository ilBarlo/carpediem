...
ITEMS = [
    ("pumi-dipinti", "Pumi Dipinti"),
    ("pumi-bianchi", "Pumi Bianchi"),
    ("lampada-pumo", "Lampada Pumo"),
    ("lampada-volto", "Lampada Volto"),
    ("testa-dipinta", "Testa Dipinta"),
    ("cavalieri", "Cavalieri"),
    ("centrotavola-melagrane", "Centrotavola Melagrane"),
    ...
    ("uovo-colomba", "Uovo Colomba"),
    ("uova-rose", "Uova con Rose"),
    ("vassoi-mare", "Vassoi Mare"),
    ("pesci-parete", "Pesci a Parete"),
    ("ricci-mare", "Ricci di Mare"),
    ("ovetto-ancora", "Ovetto Ancora"),
    ("polpo", "Polpo"),
    ("bonsai-ulivo", "Bonsai di Ulivo"),
    ("bomboniere-traforate", "Bomboniere Traforate"),
]
